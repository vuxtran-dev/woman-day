...
const messages = [
    "Gửi đến người phụ nữ tuyệt vời nhất vừa xuất hiện ",
    "Mong em gặp được nhiều niềm vui và hạnh phúc trong ngày tháng tới",
    "Mong sự xuất hiện của anh sẽ giúp em chia sẻ niềm vui nỗi buồn và làm  em vui vẻ hơn",
    "Mong rằng đoạn đường tới thì anh sẽ có cơ hội đồng hành cùng em",
    "Không vội vàng, từ từ chậm rãi nhưng không cẩu thả vì anh muốn cho em sự an toàn lớn nhất",
    "Chúc bạn nhỏ ngày 8/3 vui vẻ nhé !!!"
];
